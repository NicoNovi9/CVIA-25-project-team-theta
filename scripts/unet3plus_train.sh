#!/bin/bash -l
#SBATCH --job-name=train_unet3plus
#SBATCH --time=4:00:00
...
#SBATCH --output=unet3plus_train.out
#SBATCH --error=unet3plus_train.err

echo "=================================================="
echo "UNet3+ Training with Pretrained Backbone"
echo "=================================================="
...
# Default training with ConvNeXt-Tiny backbone
srun python -u src/unet3plus/train_unet3plus.py \
